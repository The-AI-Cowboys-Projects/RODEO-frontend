export default function FeedbackIcon({ className = 'w-5 h-5', primary = '#800080', secondary = '#C38BBF', detail = 'white', ...props }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" {...props}>
      ...
      <path d="M22 12C22 6.48 17.52 2 12 2" stroke={detail} strokeWidth="1.5" strokeLinecap="round" strokeDasharray="3 2" />
      ...
      <path d="M9 12L11 14L15 10" stroke={detail} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
