export default function KnowledgeIcon({ className = 'w-5 h-5', primary = '#800080', secondary = '#C38BBF', detail = 'white', ...props }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" {...props}>
      ...
      <line x1="8" y1="7" x2="16" y2="7" stroke={detail} strokeWidth="1.2" strokeLinecap="round" />
      <line x1="8" y1="10.5" x2="16" y2="10.5" stroke={detail} strokeWidth="1.2" strokeLinecap="round" />
      <line x1="8" y1="14" x2="13" y2="14" stroke={detail} strokeWidth="1.2" strokeLinecap="round" />
