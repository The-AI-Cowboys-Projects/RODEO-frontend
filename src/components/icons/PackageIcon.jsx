export default function PackageIcon({ className = 'w-5 h-5', ...props }) {
  return (
    <svg viewBox="0 0 24 24" className={className} {...props}>
      ...
      <g className="package-body">
        <path d="M12 2L3 7v10l9 5 9-5V7l-9-5z" fill="#800080" />
        <path d="M12 12L3 7v10l9 5 9-5V7l-9 5z" fill="#C38BBF" fillOpacity="0.3" />
      </g>
