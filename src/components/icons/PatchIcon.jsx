export default function PatchIcon({ className = 'w-5 h-5', primary = '#800080', secondary = '#C38BBF', ...props }) {
  return (
    <svg viewBox="0 0 24 24" className={className} {...props}>
      ...
      <g className="bandage-body">
        {/* Bandage shape */}
        <rect x="2" y="8" width="20" height="8" rx="4" fill={primary} />
        {/* Center pad */}
        <rect x="8" y="9" width="8" height="6" rx="1" fill="white" fillOpacity="0.7" />
      </g>
      {/* Animated dots on pad */}
      <circle className="heal-dot-1" cx="10" cy="12" r="0.8" fill={primary} />
      <circle className="heal-dot-2" cx="12" cy="11" r="0.8" fill={secondary} />
      <circle className="heal-dot-3" cx="14" cy="13" r="0.8" fill={primary} />
      <circle className="heal-dot-4" cx="12" cy="13" r="0.8" fill={secondary} />
    </svg>
  )
}
