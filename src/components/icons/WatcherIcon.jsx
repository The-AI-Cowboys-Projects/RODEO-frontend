export default function WatcherIcon({ className = 'w-5 h-5', ...props }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" {...props}>
      ...
      `}</style>
      <path className="watcher-eye" d="M1 12C1 12 5 5 12 5C19 5 23 12 23 12C23 12 19 19 12 19C5 19 1 12 1 12Z" stroke="#C38BBF" strokeWidth="1.5" />
      <circle className="watcher-iris" cx="12" cy="12" r="3.5" stroke="white" strokeWidth="1.5" />
      <circle className="watcher-pupil" cx="12" cy="12" r="1.5" fill="#C38BBF" />
